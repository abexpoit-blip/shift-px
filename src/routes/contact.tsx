    ...
    <BreezyLayout>
      <section className="max-w-5xl mx-auto px-6 py-20 grid md:grid-cols-2 gap-12">
        <div>
          ...
          <h1
            className="text-5xl text-[#2A2A28] mb-6"
            style={{ fontFamily: "'Instrument Serif', serif", fontWeight: 400 }}
          >
            We'd love to hear from you.
          </h1>
          <p className="text-[#5A554C] mb-8 leading-relaxed">
            Whether it's a question about a product, a return, or just to say hi — our small team
            reads every message and responds within 24 hours on business days.
          </p>

          <div className="space-y-5 text-sm">
            <div>
              <div className="text-xs uppercase tracking-wider text-[#7D9B76] font-semibold mb-1">
                Email
              </div>
              <a href={`mailto:${brand.email}`} className="text-[#2A2A28] hover:text-[#5A7A55]">
                {brand.email}
              </a>
            </div>
            <div>
        ...
        >
          <div>
            <label className="block text-xs uppercase tracking-wider text-[#5A554C] font-semibold mb-2">
              Name
            </label>
            <input
              name="name"
              required
              className="w-full px-4 py-3 rounded-lg border border-[#E8E2D5] outline-none focus:border-[#5A7A55] text-sm"
            />
          </div>
          <div>
            <label className="block text-xs uppercase tracking-wider text-[#5A554C] font-semibold mb-2">
          ...
          <button
            type="submit"
            className="w-full bg-[#2A2A28] text-[#FAF7F2] py-3 rounded-full text-sm font-semibold hover:bg-[#5A7A55] transition-colors"
          >
            Send message
          </button>
        </form>
