            ...
            <div className="overflow-y-auto max-h-[440px]">
              ...
              {!q.isLoading && items.length === 0 && (
                <div className="px-5 py-12 text-center">
                  ...
                  <div className="text-[11px] text-[#A38D7D] mt-1">
                  ...
                  >
                    <div className="flex gap-3">
                      ...
                      <div className="relative shrink-0">
                        <div
                          className={`absolute inset-0 rounded-xl bg-gradient-to-br ${tone.ring} blur-sm opacity-50`}
                        />
                        <div
                          className={`relative w-10 h-10 rounded-xl bg-gradient-to-br ${tone.iconBg} flex items-center justify-center ${tone.glow}`}
                        >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          {b.tone === "premium" && (
                            <span
                              className={`text-[9.5px] font-extrabold px-2 py-0.5 rounded-full ${tone.badge} shadow-sm tracking-wide uppercase`}
                            >
                              ✨ Premium
                            </span>
                          )}
                          <span className="text-[10px] text-[#A38D7D] font-medium">
