...
export const Route = createFileRoute("/blog/")({
  ...
  head: ({ loaderData }) => {
    ...
    const { meta, links } = buildOg({
      ...
      description:
        "Sleep science, wellness, gift guides, and travel — written by our editors and experts.",
      type: "website",
    });
    return { meta, links };
  },
      ...
      <section className="bg-[#F2EDE3]">
        <div className="max-w-4xl mx-auto px-6 py-20 text-center">
          ...
          <p className="text-[#5A554C]">
            Sleep, wellness, gear, and slow living — researched and written by our team.
          </p>
        </div>
      </section>
            ...
            return (
              ...
              >
                ...
                <div className="p-7">
                  ...
                  <h2
                    className="text-2xl text-[#2A2A28] mb-3 leading-snug group-hover:text-[#5A7A55] transition-colors"
                    style={{ fontFamily: "'Instrument Serif', serif", fontWeight: 400 }}
                  >
                    {a.title}
                  </h2>
