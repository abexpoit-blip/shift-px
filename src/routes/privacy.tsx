  ...
  return (
    <BreezyLayout>
      <article className="max-w-3xl mx-auto px-6 py-16 prose prose-lg text-[#3A3A38]">
        ...
        <p>
          {brand.name} ("we," "our," or "us") respects your privacy. This Privacy Policy explains
        ...
        <p>
          We collect personal information you voluntarily provide when placing an order, creating an
          account, subscribing to our newsletter, or contacting us. This includes your name, email
          address, postal address, phone number, and payment information (processed via our
          PCI-compliant payment partner; we never store full card numbers).
        </p>
        <p>
          We also automatically collect certain information when you visit the site: IP address,
          browser type, operating system, pages viewed, and timestamps. We use cookies and similar
          tracking technologies to remember your preferences and improve your experience.
        </p>
        ...
        <p>
          We never sell your personal information. We share data only with trusted service providers
          (payment processors, shipping carriers, email platforms, analytics) under strict
          confidentiality agreements, and only when necessary to operate the business.
        </p>
        ...
        <p>
          ...
          hold about you, request correction or deletion, opt out of marketing, and request a copy
          of your data. To exercise any of these rights, email{" "}
        ...
        <p>
          We use industry-standard encryption (SSL/TLS) for all data transmission and follow best
          practices to safeguard the information we store. No system is 100% secure, but we work
          hard to protect your data.
        </p>
