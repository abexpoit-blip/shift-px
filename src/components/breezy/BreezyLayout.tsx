    ...
    <header className="border-b border-[#E8E2D5] bg-[#FAF7F2]/95 backdrop-blur sticky top-0 z-40">
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between gap-4">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm text-[#5A554C]">
          <Link to="/shop" className="hover:text-[#5A7A55] transition-colors">
            Shop
          </Link>
          <Link to="/blog" className="hover:text-[#5A7A55] transition-colors">
            Journal
          </Link>
          <Link to="/about" className="hover:text-[#5A7A55] transition-colors">
            About
          </Link>
          <Link to="/faq" className="hover:text-[#5A7A55] transition-colors">
            FAQ
          </Link>
          <Link to="/contact" className="hover:text-[#5A7A55] transition-colors">
            Contact
          </Link>
        </nav>
    ...
    <footer className="border-t border-[#E8E2D5] bg-[#F2EDE3] mt-24">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-5 gap-10">
        <div className="md:col-span-2">
          ...
          <p className="text-xs text-[#9A9488] mt-4">
            Est. {SITE.founded} · {brand.city}
          </p>
        ...
        <div>
          <h4 className="text-xs uppercase tracking-wider text-[#5A554C] mb-4 font-semibold">
            Shop
          </h4>
          <ul className="space-y-2 text-sm text-[#7A7468]">
            ...
            <li>
              <Link to="/cart" className="hover:text-[#5A7A55]">
                Your cart
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-[#7A7468]">
            <li>
              <Link to="/faq" className="hover:text-[#5A7A55]">
                FAQ
              </Link>
            </li>
            <li>
              <Link to="/size-guide" className="hover:text-[#5A7A55]">
                Size guide
              </Link>
            </li>
            <li>
              <Link to="/shipping" className="hover:text-[#5A7A55]">
                Shipping
              </Link>
            </li>
            <li>
              <Link to="/returns" className="hover:text-[#5A7A55]">
                Returns
              </Link>
            </li>
            <li>
              <Link to="/contact" className="hover:text-[#5A7A55]">
                Contact
              </Link>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-[#7A7468]">
            <li>
              <Link to="/about" className="hover:text-[#5A7A55]">
                About us
              </Link>
            </li>
            <li>
            ...
            <li>
              <Link to="/privacy" className="hover:text-[#5A7A55]">
                Privacy
              </Link>
            </li>
            <li>
              <Link to="/terms" className="hover:text-[#5A7A55]">
                Terms
              </Link>
            </li>
          </ul>
